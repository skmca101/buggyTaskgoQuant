...
export class RegisterUser {
  constructor(page) {
    ...
    this.existingUnameMsg = page.getByText("UsernameExistsException: User");
    this.existLoc = page.locator("div[class='result alert alert-danger']")
  ...
  async verifyUsernameExistMsg(msg)
  {
    ...
    await expect(this.existLoc).toHaveText(msg)
